          ...
          <div className="space-y-12 sm:space-y-16 md:space-y-20">
            ...
            <div>
              <div className="flex items-center gap-4 mb-4 sm:mb-6">
                <span className="font-hero text-4xl sm:text-5xl font-bold text-ink/40">01</span>
            ...
            <div>
              <div className="flex items-center gap-4 mb-4 sm:mb-6">
                <span className="font-hero text-4xl sm:text-5xl font-bold text-ink/40">02</span>
                <h2 className="font-subheading text-xl sm:text-2xl text-ink font-semibold">Information We Collect</h2>
              </div>
              <div className="space-y-6">
                <div className="border-l-2 border-ink/20 pl-4 sm:pl-6">
                  <h3 className="font-subheading text-lg text-ink font-medium mb-2">Camera Access</h3>
                ...
                <div className="border-l-2 border-ink/20 pl-4 sm:pl-6">
                  <h3 className="font-subheading text-lg text-ink font-medium mb-2">Local Storage</h3>
                  <p className="font-body text-mid text-base leading-relaxed">
                    We may use your browser's local storage to save your preferences and session data. This data remains on your device.
                  </p>
                </div>
                <div className="border-l-2 border-ink/20 pl-4 sm:pl-6">
                  <h3 className="font-subheading text-lg text-ink font-medium mb-2">Analytics</h3>
                  <p className="font-body text-mid text-base leading-relaxed">
            ...
            <div>
              <div className="flex items-center gap-4 mb-4 sm:mb-6">
                <span className="font-hero text-4xl sm:text-5xl font-bold text-ink/40">03</span>
                <h2 className="font-subheading text-xl sm:text-2xl text-ink font-semibold">Third-Party Services</h2>
              </div>
              <p className="font-body text-mid text-base leading-relaxed mb-4">
                Our app may include:
              </p>
              <ul className="space-y-3 font-body text-mid text-base">
            ...
            <div>
              <div className="flex items-center gap-4 mb-4 sm:mb-6">
                <span className="font-hero text-4xl sm:text-5xl font-bold text-ink/40">04</span>
            ...
            <div>
              <div className="flex items-center gap-4 mb-4 sm:mb-6">
                <span className="font-hero text-4xl sm:text-5xl font-bold text-ink/40">05</span>
            ...
            <div>
              <div className="flex items-center gap-4 mb-4 sm:mb-6">
                <span className="font-hero text-4xl sm:text-5xl font-bold text-ink/40">06</span>
            ...
            <div>
              <div className="flex items-center gap-4 mb-4 sm:mb-6">
                <span className="font-hero text-4xl sm:text-5xl font-bold text-ink/40">07</span>
            ...
            <div>
              <div className="flex items-center gap-4 mb-4 sm:mb-6">
                <span className="font-hero text-4xl sm:text-5xl font-bold text-ink/40">08</span>
